...
modelArrayGen = [knn_gender, lr_gender, rf_gender, nc_gender ]
print("\n\n******************************************************************\nHARD VOTE FOR GENDERS")
hvGender = hv.hard_vote(modelArrayGen, test_protein_sub_set, test_gender_labels, 'gender')
#print(hvGender)
print("******************************************************************")

# #All of the other models that are not being trained here for msi right now should be added to this array.
print("\n\n******************************************************************\nHARD VOTE FOR MSI")
modelArrayMSI = [knn_msi, lr_msi, rf_msi, nc_msi]
hvMSI = hv.hard_vote(modelArrayMSI, test_protein_sub_set, test_MSI_labels, 'msi')
#print(hvMSI)
print("******************************************************************")
